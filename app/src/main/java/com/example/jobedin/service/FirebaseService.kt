package com.example.jobedin.service
...
class FirebaseService : FirebaseMessagingService() {
    ...
    override fun onNewToken(newToken: String) {
        ...
        val uid = FirebaseAuth.getInstance().currentUser?.uid ?: "nan"
        updateCurrentUserToken(uid = uid, newToken)
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setSmallIcon(R.drawable.linkedin_icon)
            .setAutoCancel(true)
    ...
    fun updateCurrentUserToken(uid: String, token: String) {
